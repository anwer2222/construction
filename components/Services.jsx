...
const serviceData = [
  {
    name: "construction",
    icon: <PiWallFill/>,
    title: "Constraction Services",
    description: "We build with precision and innovation, ensuring that every structure is string, reliable, and built to last. From foundations to finishing touches, our experties transform ideas into reality",
    serviceList: [
      "Residential Builds",
      "Structural Design",
      "Site Prep",
  ...
  },
  {
    ...
    description: "Bringing damaged or aging structures back to life. We specialize in restoring historical landmarks, fire-damaged building, and water-damaged properties with meticulous care.",
    serviceList: [
      "Historic Restore",
      "Water Damage",
      "Fire Repair",
...
const Services = () => {
  const [activatTab, setActiveTab] = useState("construction");
  return (
      ...
      <div className="container mx-auto">
        <motion.div
          ...
          <p className="mb-11 max-w-[480px] mx-auto">
            Offering tailored construction solution, from planning to completing, with a focus on quality and innovation.
          </p>
        </motion.div>
        {/* tabs */}
        <motion.div
         ...
         whileInView="show"
         viewport={{once: false, amount: 0.2}}>
          <Tabs defaultValue="construction" onValueChange={(value) => setActiveTab(value)} className="flex flex-col xl:flex-row w-full gap-[30px]">
            <TabsList className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 gap-[30px] h-full w-full xl:w-[400px] rounded-none p-0 bg-transparent xl-w-[345px]">
              {serviceData.map( (item) => {
                return (
                  ...
                  className="w-full rounded-none h-[100px] flex items-center relative shadow-custom p-0 outline-none">
                    <div className={`w-[100px] h-[100px] flex items-center justify-center absolute left-0 ${activatTab === item.name ? "bg-primary text-white": "bg-accent text-primary"}`}>
