  ...
  return (
    <Sheet open= {isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="bg-primary border-none text-white">
        <div className="flex flex-col pt-16 pb-8 items-center justify-between">
          <SheetHeader>
            <SheetTitle>
              <Logo />
            </SheetTitle>
          ...
          <ul className="w-full flex flex-col pt-12 gap-10 justify-center text-center">
          ...
          <Socials containerStyles="text-white text-xl flex gap-6 pt-12"/>
