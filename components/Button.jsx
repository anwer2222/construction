const { RiArrowRightUpLine } = require("react-icons/ri")
...
const Button = ({text}) => {
  return (
    <button className="w-[210px] h-[54px] py-[5px] pl-[10px] flex items-center justify-between min-w-[200px] group bg-accent">
